...
export const handlers = [
  ...
  // Metrics endpoints
  http.get(`${baseUrl}/api/v1/metrics/overview`, () => {
    return HttpResponse.json({
      uptime_seconds: 3600,
      total_projects: 5,
      total_files: 150,
  ...
  http.get(`${baseUrl}/api/v1/metrics/projects`, () => {
    return HttpResponse.json([
      {
        project_id: 'proj-1',
  ...
  http.get(`${baseUrl}/api/v1/metrics/chat`, () => {
    return HttpResponse.json({
      total_sessions: 10,
      total_messages: 100,
      messages_per_session: 10.0,
    })
  }),

  http.get(`${baseUrl}/api/v1/metrics/storage`, () => {
    return HttpResponse.json({
      total_size_bytes: 1024000,
      db_size_bytes: 512000,
      vector_size_bytes: 512000,
    })
  }),

  http.get(`${baseUrl}/api/v1/metrics/sync`, () => {
    return HttpResponse.json({
      total_jobs: 5,
      completed_jobs: 5,
      failed_jobs: 0,
